...
export const SearchResults: React.FC = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                setProducts([
                    { id: 1, name: "Search Result 1", price: 99.99, image: "https://picsum.photos/200/306" },
                    { id: 2, name: "Search Result 2", price: 149.99, image: "https://picsum.photos/200/307" }
                ]);
                setLoading(false);
            } catch (err: any) {
    ...
    if (loading) return <div className="p-10 text-center text-gray-500">Loading Search Results...</div>;
