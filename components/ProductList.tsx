...
// Vulnerability: Code Duplication (JSCPD target)
    ...
    useEffect(() => {
        ...
        const fetchProducts = async () => {
            try {
                ...
                // Simulating malicious data from backend
                setProducts([
                    { id: 1, name: "Super Widget", price: 19.99, image: "https://picsum.photos/200/300" },
                    { id: 2, name: "<img src=x onerror=alert('XSS') /> Malicious Product", price: 29.99, image: "https://picsum.photos/200/301" },
                    { id: 3, name: "Gadget Pro", price: 49.99, image: "https://picsum.photos/200/302" }
                ]);
                setLoading(false);
            } catch (err: any) {
